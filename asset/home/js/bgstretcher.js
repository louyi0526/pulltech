;(function($){
	...
	$.fn.bgStretcher = function(settings){
		...
		function _genHtml(body_content){
			...
			window.onresize = function(){
				pmh = document.documentElement.clientHeight;
			}
			body_content.each(function(){
				...
				cur_bgstretcher.children('.bgstretcher-page').css({'position': 'relative', 'z-index': 3,'height': pmh });
			});
	...
	$.fn.bgStretcher.pagination = function(){
		...
		if (l > 0) {
			output += '<ul>';
				for (i = 0; i < l; i++){
					output += '<li style="margin-left:5px;"><a style="width: 50px;" href="javascript:;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a></li>';
				}
			output += '</ul>';
